 ...
 * </p>
 * <ul>
 *   <li>{@link com.b2international.snomed.etl.etl.SubExpression#getFocusConcepts <em>Focus Concepts</em>}</li>
 *   <li>{@link com.b2international.snomed.etl.etl.SubExpression#getRefinement <em>Refinement</em>}</li>
 * </ul>
 *
 * @see com.b2international.snomed.etl.etl.EtlPackage#getSubExpression()
 * @model
 * @generated
 */
public interface SubExpression extends AttributeValue
{
   ...
   * The list contents are of type {@link com.b2international.snomed.etl.etl.FocusConcept}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Focus Concepts</em>' containment reference list.
   * @see com.b2international.snomed.etl.etl.EtlPackage#getSubExpression_FocusConcepts()
   ...
   * @see com.b2international.snomed.etl.etl.EtlPackage#getSubExpression_Refinement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.b2international.snomed.etl.etl.SubExpression#getRefinement <em>Refinement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
